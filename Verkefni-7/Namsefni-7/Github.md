...
* Til að Git geti tengst við Github þá verður að skrá Github notandanafnið þitt og tölvupóstfang í Git bash (PC) eða _terminal_ (AM). [$já nánar](https://vefgrunnur.github.io/verkefnaskil/git_innsetning.html) 
```
